from flask import Flask, render_template   # flask 모듈과 관련 함수 불러옴
...
sw_state_list = [0, 0, 0]   # 스위치의 눌림 여부를 기록한 list형 변수 선언

@app.route('/')                       # 기본 주소
def home():
    for ii in range(3):               # 스위치의 눌림 여부를 현황 변수에 저장
...
if __name__ == "__main__":  # 웹사이트를 호스팅하여 접속자에게 보여주기 위한 부분
   ...
   # 해당 내부 IP와 port를 포트포워딩 해두면 외부에서도 접속 가능
